    ...
    handleLogIn(event) {
        ...
        axios.post(API_URL, {
            ...
            .then(response => {
                ...
                if (response.data.headers.authorization != null 
                    && response.data.headers.authorization != "") {
                    localStorage.setItem("key", response.data.headers.authorization );
                    localStorage.setItem("user_role", response.data.headers.role );
